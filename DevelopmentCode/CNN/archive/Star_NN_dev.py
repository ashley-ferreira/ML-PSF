...
def train_CNN(model_dir_name, num_epochs, data):
    ...
    class CustomSaver(keras.callbacks.Callback):
        ...
        def on_epoch_end(self, epoch, logs={}):
            if (epoch+1) % 10 == 0:
                self.model.save(model_dir_name + 'models_og_32bs/' + "model_{}".format(epoch+1))
    ...
    batch_size = 32#1024*2 # up from 16 --> 1024 --> 32 --> 256
    dropout_rate = 0.2
    test_fraction = 0.05 # from 0.05
    learning_rate = 0.001 # down from 0.001 --> 0.0005 --> 0.00001
