...
def train_CNN(model_dir_name, num_epochs, data):
    ...
    class CustomSaver(keras.callbacks.Callback):
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            self.model.save(model_dir_name + 'models_lr=0.0001/' + "model_{}".format(epoch+1))
    ...
    batch_size = 1024 # up from 16 --> 1024 --> 32 --> 256
    dropout_rate = 0.2
    test_fraction = 0.05 # try 50 
    learning_rate = 0.0001 # down from 0.001 --> 0.0005 --> 0.00001
