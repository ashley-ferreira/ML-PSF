...
def convnet_model_complex(input_shape, unique_labs=2, dropout_rate=0.2):
    '''
    ...
    #hidden layer 1
    model.add(Conv2D(filters=32, input_shape=input_shape, activation='relu', padding='same', kernel_size=(3,3)))
