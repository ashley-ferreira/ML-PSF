...
ml_preds = [0.5049, 0.627114, 0.6088, 0.6094, 0.6114, 0.6723]
time_ml = [0.5796, 0.72742, 0.71030, 0.7161, 0.703265, 0.777109]
time_nonml = [61.096, 118.0005, 133.888, 158.418, 85.749, 177.521]
# log axis?
...
plt.legend(["ml prediction only time", "ml process time", "non-ml proccess time"], loc='lower right')
plt.show()